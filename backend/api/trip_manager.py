...
class TripManager:
    ...
    async def generate_itinerary(trip):
        ...
        logger.info("TRIP MANAGER: preparing info")
        ...
        logger.info("TRIP MANAGER: preparing date")
        ...
        logger.info("TRIP MANAGER: user_data")
        ...
        logger.info("TRIP MANAGER: build_schedule")
